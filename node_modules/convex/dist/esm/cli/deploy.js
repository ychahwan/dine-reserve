...
export const deploy = new Command("deploy").summary("Deploy to a production or preview deployment").description(
  [
  ...
  if (deploymentSelection.kind === "preview") {
    const previewName = cmdOptions.previewCreate ?? cmdOptions.previewName ?? gitBranchFromEnvironment();
