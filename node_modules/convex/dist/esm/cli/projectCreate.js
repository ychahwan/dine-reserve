...
async function runProjectCreate(nameArg, options) {
  ...
  logFinishedStep(
    `Created project ${chalkStderr.bold(projectSlug)} in team ${chalkStderr.bold(team.slug)}, manage it at ${chalkStderr.bold(
...
export const projectCreate = new Command("create").summary("Create a new project").description(
  [
