...
const optionalStringToNullSchema = z.unknown().optional().transform((value) => typeof value === "string" ? value : null);
const optionalTrueToBooleanSchema = z.unknown().optional().transform((value) => value === true);
...
export function validateAgentSkillCatalogResult(json) {
