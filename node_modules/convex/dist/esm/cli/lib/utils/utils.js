...
export function readDeployKeyFromEnv(getEnv) {
...
export function permissionDeniedErrorMessage(errorMessage) {
...
export async function logNoDefaultRegionMessage(teamSlug) {
