 ...
 */
export declare function ensureConvexFunctionsDir(ctx: Context, projectConfig: ProjectConfig): Promise<void>;
 ...
 */
export declare function writeAiFilesConfig({ projectDir, aiFiles, }: {
    projectDir: string;
