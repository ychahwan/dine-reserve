...
export declare function ensureLoggedInWithAccessToken(ctx: Context, action: string): Promise<void>;
/**
 * Crashes unless the auth can create a deployment: personal access tokens and
 * project keys are accepted, deploy keys are not.
 */
export declare function ensureAuthCanCreateDeployment(ctx: Context): Promise<void>;
/**
 ...
 */
export declare function getProjectDetails(ctx: Context, projectSelection: ProjectSelection): Promise<PlatformProjectDetails>;
export {};
