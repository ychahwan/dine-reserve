...
export declare function loadGlobalDashboardConfig(ctx: Context): GlobalDashboardConfig | null;
export declare function saveGlobalDashboardConfig(ctx: Context, config: GlobalDashboardConfig): void;
/**
...
export declare function loadProjectDashboardConfig(ctx: Context, deploymentName: string): ProjectDashboardConfig | null;
export declare function saveProjectDashboardConfig(ctx: Context, deploymentName: string, config: ProjectDashboardConfig): void;
