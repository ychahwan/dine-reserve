...
export declare const LEGACY_LOCAL_BACKEND_INSTANCE_SECRET = "4361726e697461732c206c69746572616c6c79206d65616e696e6720226c6974";
/**
 * Generates an instance secret and an admin key for a new (or just upgraded) local deployment.
 */
export declare function generateLocalDevSecrets(ctx: Context, { deploymentName, latestBinaryPath, }: {
 ...
 */
export declare function generateLocalDevSecretsWithLatestBinary(ctx: Context, { deploymentName, }: {
    deploymentName: string;
}): Promise<{
    instanceSecret: string;
    adminKey: string;
