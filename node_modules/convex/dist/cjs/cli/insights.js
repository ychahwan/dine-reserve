...
).allowExcessArguments(false).option("--details", "Show recent events for each insight", false).option("--json", "Output insights as JSON", false).addDeploymentSelectionOptions((0, import_command.actionDescription)("Show insights for")).showHelpAfterError().action(async (cmdOptions) => {
