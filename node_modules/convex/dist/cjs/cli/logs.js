...
const logs = new import_extra_typings.Command("logs").summary("Watch logs from your deployment").description(
  ...
  (0, import_announceDeploymentTarget.announceDeploymentTarget)("Showing logs of deployment:", deployment);
