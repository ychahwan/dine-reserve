...
__export(deploy2_exports, {
  ...
  fetchDeploymentCanonicalUrls: () => fetchDeploymentCanonicalUrls,
...
async function fetchDeploymentCanonicalUrls(ctx, options) {
  const client = (0, import_utils.typedDeploymentClient)(ctx, options);
