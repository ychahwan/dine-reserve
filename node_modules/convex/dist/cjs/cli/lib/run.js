...
__export(run_exports, {
  ...
  pushToDeployment: () => pushToDeployment,
...
async function runFunctionAndLog(ctx, args) {
  ...
  try {
    ...
    const permissionError = (0, import_utils.permissionDeniedErrorMessage)(errorMessage);
    if (permissionError !== null) {
      return await ctx.crash({
        exitCode: 1,
        errorType: "fatal",
        printedMessage: import_chalk.chalkStderr.red(permissionError)
      });
    }
    ...
    (updatedQueries) => {
      for (const queryToken of updatedQueries) {
        ...
        try {
          ...
          const permissionError = (0, import_utils.permissionDeniedErrorMessage)(
            err.toString()
          );
          if (permissionError !== null) {
            void ctx.crash({
...
async function pushToDeployment(ctx, args) {
