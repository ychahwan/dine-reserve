...
__export(componentDefinition_exports, {
  ...
  componentEnvBinding: () => componentEnvBinding,
  componentEnvDependencyValidator: () => componentEnvDependencyValidator,
...
const componentEnvDependencyValidator = (0, import_utils.looseObject)({
...
const componentDefinitionType = import_zod.z.union([
  (0, import_utils.looseObject)({
    ...
    httpPrefix: import_zod.z.string().optional()
  }),
  (0, import_utils.looseObject)({
...
const componentEnvBinding = import_zod.z.union([
  (0, import_utils.looseObject)({
    type: import_zod.z.literal("value"),
  ...
  (0, import_utils.looseObject)({
    type: import_zod.z.literal("envVar"),
...
const componentInstantiation = (0, import_utils.looseObject)({
  ...
  env: import_zod.z.array(import_zod.z.tuple([import_types.identifier, componentEnvBinding])).nullish()
});
...
const componentDefinitionMetadata = (0, import_utils.looseObject)({
  ...
  envVars: import_zod.z.array(import_zod.z.tuple([import_types.identifier, componentEnvDependencyValidator])).nullish()
});
