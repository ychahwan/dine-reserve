...
const SLOW_TYPECHECK_DOCS_URL = "https://docs.convex.dev/cli/troubleshooting/typecheck-performance";
...
async function typeCheckFunctionsInMode(ctx, typeCheckMode, functionsDir) {
  ...
  maybeLogSlowTypecheckSuggestion(ctx, import_perf_hooks.performance.now() - typecheckStart);
}
  ...
  switch (typescriptCompiler) {
    case "tsgo": {
      const tsgoPaths = ["tsgo", "tsgo.js"].map(
        (filename) => import_path.default.join(
          "node_modules",
          "@typescript",
          "native-preview",
          "bin",
...
function maybeLogSlowTypecheckSuggestion(ctx, durationMs) {
