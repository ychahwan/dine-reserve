...
__export(envvars_exports, {
  ...
  getDefaultDeployMessage: () => getDefaultDeployMessage,
...
function getDefaultDeployMessage() {
  const platforms = [
    {
      name: "GitHub Actions",
    ...
    },
    {
      ...
      detect: () => !!process.env.BUILD_ID && !!process.env.PROJECT_ID && !!process.env.PROJECT_NUMBER && !!process.env.LOCATION,
