...
__export(download_exports, {
  _findLatestVersionWithBinary: () => _findLatestVersionWithBinary,
...
async function _findLatestVersionWithBinary(ctx, requireSuccess) {
...
async function ensureDashboardDownloaded(ctx, version) {
  const config = (0, import_filePaths.loadGlobalDashboardConfig)(ctx);
  ...
  (0, import_filePaths.saveGlobalDashboardConfig)(ctx, { version });
}
