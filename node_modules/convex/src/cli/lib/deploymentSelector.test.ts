...
describe("parseDeploymentSelector", () => {
  ...
  test('"myproject:local"', () => {
    expect(parseDeploymentSelector("myproject:local")).toEqual({
      kind: "inProject",
  ...
  test('"myteam:myproject:local"', () => {
    expect(parseDeploymentSelector("myteam:myproject:local")).toEqual({
      kind: "inTeamProject",
      teamSlug: "myteam",
      projectSlug: "myproject",
      selector: { kind: "local" },
